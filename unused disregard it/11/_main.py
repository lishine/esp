...
<body>
    ...
    <div class="readings">
        ...
        <h2>DS18B20 Temperatures</h2>
        <p>DS18B20 Temperatures: <span id="ds18_temp">--</span></p>
    ...
    <script>
        setInterval(() => {
            ...
            .then(data => {
                ...
                if(data.ds18_temperatures) {
                    document.getElementById('ds18_temp').textContent = data.ds18_temperatures.join(", ");
                }
    ...
    try:
        ...
        if '/data' in request:
            ...
            response = {
                ...
                'esc_rpm': esc_rpm,
                'esc_temp': esc_temp,
                'ds18_temperatures': ds18_temperatures
            }
